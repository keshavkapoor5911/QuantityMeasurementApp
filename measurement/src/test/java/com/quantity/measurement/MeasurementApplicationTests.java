...
// ===============================
    ...
    void testQuantityEntity_SingleOperandConstruction() {
        QuantityMeasurementEntity e = new QuantityMeasurementEntity(
                "CONVERT", "Quantity(1.0, FEET)", "INCH", "Quantity(12.0, INCH)");
        assertEquals("CONVERT",            e.getOperationType());
        assertEquals("Quantity(1.0, FEET)", e.getInput1Value());
        assertNull(e.getInput2Value());
        assertEquals("INCH",               e.getTargetUnit());
        assertEquals("Quantity(12.0, INCH)", e.getResultValue());
    ...
    void testQuantityEntity_BinaryOperandConstruction() {
        ...
        assertEquals("Quantity(1.0, FEET)", e.getInput1Value());
        assertEquals("Quantity(12.0, INCH)", e.getInput2Value());
        assertEquals("FEET",              e.getTargetUnit());
        assertEquals("Quantity(2.0, FEET)", e.getResultValue());
        assertFalse(e.hasError());
    }
    ...
    void testQuantityEntity_ToString_Error() {
        QuantityMeasurementEntity e = new QuantityMeasurementEntity(
                "ADD", "in1", "in2", "some error", true);
        String s = e.toString();
        assertTrue(s.contains("error") || s.contains("some error"));
    }
    ...
    void testService_CompareEquality_SameUnit_Success() {
        ...
        QuantityDTO d2 = new QuantityDTO(1.0, "FEET", "LENGTH");
        QuantityDTO result = service.compare(d1, d2);
        assertFalse(result.hasError());
        assertEquals(1.0, result.getScalarResult(), 1e-6); // 1.0 = true
    }
    ...
    void testService_CompareEquality_DifferentUnit_Success() {
        ...
        QuantityDTO result = service.compare(d1, d2);
        assertFalse(result.hasError());
        assertEquals(1.0, result.getScalarResult(), 1e-6);
    }

    @Test
    void testService_CompareEquality_CrossCategory_Error() {
        QuantityDTO d1 = new QuantityDTO(1.0, "FEET",     "LENGTH");
        QuantityDTO d2 = new QuantityDTO(1.0, "KILOGRAM", "WEIGHT");
        QuantityDTO result = service.compare(d1, d2);
    ...
    void testService_Convert_Success() {
        ...
        QuantityDTO target = new QuantityDTO(0,   "INCH", "LENGTH");
    ...
    void testService_Add_Success() {
        QuantityDTO d1 = new QuantityDTO(1.0,  "FEET", "LENGTH");
        QuantityDTO d2 = new QuantityDTO(12.0, "INCH", "LENGTH");
        QuantityDTO tg = new QuantityDTO(0,    "FEET", "LENGTH");
        QuantityDTO result = service.add(d1, d2, tg);
        assertFalse(result.hasError());
    ...
    void testService_Add_UnsupportedOperation_Error() {
        QuantityDTO d1 = new QuantityDTO(100.0, "CELSIUS", "TEMPERATURE");
        QuantityDTO d2 = new QuantityDTO(50.0,  "CELSIUS", "TEMPERATURE");
        QuantityDTO result = service.add(d1, d2, d1);
        assertTrue(result.hasError());
    ...
    void testService_Subtract_Success() {
        QuantityDTO d1 = new QuantityDTO(2.0, "FEET", "LENGTH");
        QuantityDTO d2 = new QuantityDTO(1.0, "FEET", "LENGTH");
        QuantityDTO tg = new QuantityDTO(0,   "FEET", "LENGTH");
        QuantityDTO result = service.subtract(d1, d2, tg);
        assertFalse(result.hasError());
    ...
    void testService_Divide_Success() {
        QuantityDTO d1 = new QuantityDTO(10.0, "FEET", "LENGTH");
        QuantityDTO d2 = new QuantityDTO(2.0,  "FEET", "LENGTH");
        QuantityDTO result = service.divide(d1, d2);
        assertFalse(result.hasError());
        assertEquals(5.0, result.getScalarResult(), 1e-6);
    }

    @Test
    void testService_Divide_ByZero_Error() {
        QuantityDTO d1 = new QuantityDTO(10.0, "FEET", "LENGTH");
        QuantityDTO d2 = new QuantityDTO(0.0,  "FEET", "LENGTH");
        QuantityDTO result = service.divide(d1, d2);
        assertTrue(result.hasError());
    }
    ...
    void testController_DemonstrateEquality_Success() {
        QuantityDTO d1 = new QuantityDTO(1.0, "FEET", "LENGTH");
        QuantityDTO d2 = new QuantityDTO(12.0, "INCH", "LENGTH");
        QuantityDTO result = controller.performCompare(d1, d2);
        assertNotNull(result);
        assertFalse(result.hasError());
    }
    ...
    void testController_DemonstrateAddition_Success() {
        ...
        QuantityDTO d2 = new QuantityDTO(12.0, "INCH", "LENGTH");
        QuantityDTO tg = new QuantityDTO(0,    "FEET", "LENGTH");
        QuantityDTO result = controller.performAdd(d1, d2, tg);
        assertNotNull(result);
        assertFalse(result.hasError());
        assertEquals(2.0, result.getValue(), 1e-6);
    }
    ...
    void testController_DemonstrateAddition_Error() {
        QuantityDTO d1 = new QuantityDTO(100.0, "CELSIUS", "TEMPERATURE");
        QuantityDTO d2 = new QuantityDTO(50.0,  "CELSIUS", "TEMPERATURE");
        QuantityDTO result = controller.performAdd(d1, d2, d1);
        assertNotNull(result);
        assertTrue(result.hasError());
    }
    ...
    void testController_DisplayResult_Success() {
        ...
        // should not throw
        assertDoesNotThrow(() -> controller.displayResult(dto));
    }

    @Test
    void testController_DisplayResult_Error() {
        QuantityDTO dto = QuantityDTO.error("Test error");
        assertDoesNotThrow(() -> controller.displayResult(dto));
    }
    ...
    void testLayerSeparation_ServiceIndependence() {
        // Service works without a controller
        IQuantityMeasurementService svc = new QuantityMeasurementServiceImpl(
                QuantityMeasurementCacheRepository.getInstance());
        QuantityDTO d1 = new QuantityDTO(1.0, "FEET", "LENGTH");
        QuantityDTO d2 = new QuantityDTO(1.0, "FEET", "LENGTH");
        QuantityDTO result = svc.compare(d1, d2);
        assertFalse(result.hasError());
    }

    @Test
    void testLayerSeparation_ControllerIndependence() {
        // Controller works with a mock/stub service
        IQuantityMeasurementService mockService = new IQuantityMeasurementService() {
            @Override public QuantityDTO compare(QuantityDTO a, QuantityDTO b)   { return new QuantityDTO(1.0,"BOOLEAN","COMPARE"); }
            @Override public QuantityDTO convert(QuantityDTO a, QuantityDTO b)   { return new QuantityDTO(12.0,"INCH","LENGTH"); }
            @Override public QuantityDTO add(QuantityDTO a, QuantityDTO b, QuantityDTO t) { return new QuantityDTO(2.0,"FEET","LENGTH"); }
            @Override public QuantityDTO subtract(QuantityDTO a, QuantityDTO b, QuantityDTO t) { return new QuantityDTO(1.0,"FEET","LENGTH"); }
            @Override public QuantityDTO divide(QuantityDTO a, QuantityDTO b)    { QuantityDTO r=new QuantityDTO(5.0); r.setScalarResult(5.0); return r; }
        };
        QuantityMeasurementController ctrl = new QuantityMeasurementController(mockService);
        QuantityDTO d1 = new QuantityDTO(1.0, "FEET", "LENGTH");
        QuantityDTO d2 = new QuantityDTO(12.0, "INCH", "LENGTH");
        QuantityDTO result = ctrl.performCompare(d1, d2);
        assertNotNull(result);
    }
    ...
    void testDataFlow_ControllerToService() {
        QuantityDTO d1 = new QuantityDTO(1.0, "KILOGRAM", "WEIGHT");
        QuantityDTO d2 = new QuantityDTO(1000.0, "GRAM",  "WEIGHT");
        QuantityDTO result = controller.performCompare(d1, d2);
        assertFalse(result.hasError());
        assertEquals(1.0, result.getScalarResult(), 1e-6); // equal = 1.0
    }

    @Test
    void testDataFlow_ServiceToController() {
        QuantityDTO d1 = new QuantityDTO(1.0, "LITRE", "VOLUME");
        QuantityDTO d2 = new QuantityDTO(1000.0, "MILLILITRE", "VOLUME");
        QuantityDTO tg = new QuantityDTO(0, "LITRE", "VOLUME");
        QuantityDTO result = controller.performAdd(d1, d2, tg);
        assertFalse(result.hasError());
        assertEquals(2.0, result.getValue(), 1e-6);
    }
    ...
    void testBackwardCompatibility_AllUC1_UC14_Tests() {
        // Spot-check core UC operations still pass
        QuantityDTO l1 = new QuantityDTO(1.0, "FEET", "LENGTH");
        QuantityDTO l2 = new QuantityDTO(12.0, "INCH", "LENGTH");
        QuantityDTO eq = service.compare(l1, l2);
        assertFalse(eq.hasError());
        assertEquals(1.0, eq.getScalarResult(), 1e-6); // equal

        QuantityDTO cv = service.convert(l1, new QuantityDTO(0, "INCH", "LENGTH"));
        assertEquals(12.0, cv.getValue(), 1e-6);

        QuantityDTO w1 = new QuantityDTO(1.0, "KILOGRAM", "WEIGHT");
        QuantityDTO w2 = new QuantityDTO(1000.0, "GRAM",  "WEIGHT");
        QuantityDTO we = service.compare(w1, w2);
        assertFalse(we.hasError());
        assertEquals(1.0, we.getScalarResult(), 1e-6);
    }
    ...
    void testService_AllMeasurementCategories() {
        ...
        // Temperature (add should error)
        QuantityDTO r4 = service.add(
    ...
    void testController_AllOperations() {
        ...
        assertNotNull(controller.performCompare(d1, d2));
        assertNotNull(controller.performConvert(d1, tg));
        assertNotNull(controller.performAdd(d1, d2, tg));
        assertNotNull(controller.performSubtract(d1, d2, tg));
        assertNotNull(controller.performDivide(d1, d2));
    }
    ...
    void testService_ValidationConsistency() {
        // All ops should error consistently for cross-category
        QuantityDTO length = new QuantityDTO(1.0, "FEET",     "LENGTH");
        QuantityDTO weight = new QuantityDTO(1.0, "KILOGRAM", "WEIGHT");
        QuantityDTO tg     = new QuantityDTO(0,   "FEET",     "LENGTH");

        assertTrue(service.compare(length, weight).hasError());
        assertTrue(service.add(length, weight, tg).hasError());
        assertTrue(service.subtract(length, weight, tg).hasError());
        assertTrue(service.divide(length, weight).hasError());
    }
    ...
    void testEntity_Immutability() {
        ...
        assertEquals("ADD",    e.getOperationType());
        assertEquals("in1",    e.getInput1Value());
        assertEquals("in2",    e.getInput2Value());
        assertEquals("FEET",   e.getTargetUnit());
        assertEquals("result", e.getResultValue());
    }
    ...
    void testService_ExceptionHandling_AllOperations() {
        // Null DTO should throw IllegalArgumentException before any operation
        assertThrows(IllegalArgumentException.class,
                () -> service.compare(null, new QuantityDTO(1.0, "FEET", "LENGTH")));
        assertThrows(IllegalArgumentException.class,
                () -> service.add(null, new QuantityDTO(1.0, "FEET", "LENGTH"),
                        new QuantityDTO(0, "FEET", "LENGTH")));
        assertThrows(IllegalArgumentException.class,
                () -> service.divide(null, new QuantityDTO(1.0, "FEET", "LENGTH")));
    }
    ...
    void testIntegration_EndToEnd_LengthAddition() {
        // Full stack: DTO → Controller → Service → Repository → DTO
        QuantityDTO d1  = new QuantityDTO(1.0,  "FEET", "LENGTH");
        QuantityDTO d2  = new QuantityDTO(12.0, "INCH", "LENGTH");
    ...
    void testIntegration_EndToEnd_TemperatureUnsupported() {
        ...
        QuantityDTO result = controller.performAdd(c1, c2, c1);

        assertTrue(result.hasError());
        assertNotNull(result.getErrorMessage());

        // Error entity still saved
        List<QuantityMeasurementEntity> saved = repository.findByOperationType("ADD");
        assertFalse(saved.isEmpty());
        assertTrue(saved.get(0).hasError());
    }
    ...
    void testService_NullEntity_Rejection() {
        assertThrows(IllegalArgumentException.class,
                () -> service.compare(null, new QuantityDTO(1.0, "FEET", "LENGTH")));
        assertThrows(IllegalArgumentException.class,
                () -> service.compare(new QuantityDTO(1.0, "FEET", "LENGTH"), null));
    }
    ...
    void testLayerDecoupling_ServiceChange() {
        // Swap service implementation; controller is unaffected
        IQuantityMeasurementService altService = new IQuantityMeasurementService() {
            @Override public QuantityDTO compare(QuantityDTO a, QuantityDTO b) {
                QuantityDTO r = new QuantityDTO(42.0, "FEET", "LENGTH");
                return r;
            }
            @Override public QuantityDTO convert(QuantityDTO a, QuantityDTO b)              { return new QuantityDTO(0.0, "FEET","LENGTH"); }
            @Override public QuantityDTO add(QuantityDTO a, QuantityDTO b, QuantityDTO t)   { return new QuantityDTO(0.0, "FEET","LENGTH"); }
            @Override public QuantityDTO subtract(QuantityDTO a, QuantityDTO b, QuantityDTO t) { return new QuantityDTO(0.0, "FEET","LENGTH"); }
            @Override public QuantityDTO divide(QuantityDTO a, QuantityDTO b)               { return new QuantityDTO(1.0); }
        };
        QuantityMeasurementController ctrl2 = new QuantityMeasurementController(altService);
        QuantityDTO result = ctrl2.performCompare(
                new QuantityDTO(1.0, "FEET", "LENGTH"),
                new QuantityDTO(1.0, "FEET", "LENGTH"));
        assertEquals(42.0, result.getValue(), 1e-6);
    }
    ...
    void testScalability_NewOperation_Addition() {
        // Adding more operations to service layer doesn't require touching controller
        QuantityDTO d1 = new QuantityDTO(10.0, "FEET", "LENGTH");
        QuantityDTO d2 = new QuantityDTO(5.0,  "FEET", "LENGTH");
        QuantityDTO tg = new QuantityDTO(0,    "FEET", "LENGTH");

        // Existing operations still work — confirming extensibility doesn't break existing behavior
        assertFalse(controller.performAdd(d1, d2, tg).hasError());
        assertFalse(controller.performSubtract(d1, d2, tg).hasError());
        assertFalse(controller.performDivide(d1, d2).hasError());
    }
